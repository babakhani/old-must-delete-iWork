...
Public Class UnitOfWorkInstaller
    ...
    Public Sub Install(container As IWindsorContainer, store As IConfigurationStore) Implements IWindsorInstaller.Install
        container.Register(Classes.FromAssemblyInDirectory(AssemblyFilter).BasedOn(Of IUnitOfWork).WithService.FromInterface.LifestylePerWebRequest)
    End Sub
